...
public class INpactListAdapter2 extends BaseAdapter
{
	...
	enum ECellType { Normal, Loading, Info}
	...
	{	
		//Log.i("Adapter", entry.Title + " " + entry.Value + " " + mData.indexOf(entry));
	}
	...
	{	
		...
		public ViewHolder (View convertView) 
		{
	        ...
	        this.quote 		= (TextView) convertView.findViewById(R.id.CommTextViewQuote);
