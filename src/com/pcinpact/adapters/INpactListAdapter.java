...
public class INpactListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.aaa_to_delete_main_article, null);
	...
	static class ViewHolder {
		...
		public ViewHolder(View convertView) {
			...
			int tailleOptionUtilisateur = Integer.parseInt(mesPrefs.getString(context.getString(R.string.idOptionZoomTexte), ""
					+ tailleDefaut));
