...
import com.pcinpact.adapters.INpactListAdapter2.ECellType;
...
public class INpactListAdapter extends BaseAdapter
{
	...
	enum ECellType { Article, Section}
    ...
    public void fillImageView(ImageView iv, String position) 
    {
		...
		{
			iv.setImageDrawable(context.getResources().getDrawable(R.drawable.logo_pcinpact));
			return;
		}
